...
## 💡 About Me
- 🎯 **목표:** 데이터를 기반으로 하는 비즈니스 문제 해결을 즐기며, 추천시스템 및 AI 모델링부터 서비스 아키텍쳐 설계까지 아우르는 AI Engineer / Data Scientist 입니다.
- 🎓 **현재 집중하고 있는 것:** 실무 기반 비즈니스 인사이트 도출 및 MVP 제작
- 🤝 **협업 스타일:** 클라이언트가 원하는 요구사항을 이해하고 소통하는 것을 중요하게 생각합니다.
- 📫 **Contact:** alexjung0410@gmail.com
